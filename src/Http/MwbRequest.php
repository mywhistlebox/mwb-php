...
class MwbRequest
{
    ...
    function __get($name)
    {
        ...
        throw new MwbRestException($name . ' not found');
    }
    ...
    {
        if (!$this->method) {
            throw new MwbRequestException('HTTP method not specified.');
        }

        if (!in_array($this->method, ['GET', 'POST', 'DELETE'])) {
            throw new MwbRequestException('Invalid HTTP method specified.');
        }
    }
    ...
    /**
     * Generate and return the URL for this request based on method.
     *
     * @return string
     */
    public function makeMethodUrl()
    {
        $this->validateMethod();
